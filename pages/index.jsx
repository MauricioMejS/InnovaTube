...
export async function fetchFavorites(favorites) {
  const responseFavorites = fetch("/api/favorites/post", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  return (
    <div>
      ...
      <Container maxWidth="lg" sx={{ mt: 4 }}>
        <input
          className="px-3 py-2 rounded-xl w-full mb-6"
              ...
              <Card className="rounded-[12px]">
                <CardActionArea>
                  ...
                  <CardContent className="p-2">
                    <label className="label-container">{video.title}</label>
                  </CardContent>
                </CardActionArea>
                <CardActions>
                  <IconButton aria-label="add to favorites">
                    <FavoriteIcon onClick={() => handleFavoriteClick(video)} />
                  </IconButton>
                </CardActions>
              </Card>
            </Grid>
